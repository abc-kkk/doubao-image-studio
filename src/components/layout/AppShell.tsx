  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-[#0f0f10] border border-white/5">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        {/* 顶部标题栏 */}
        <div className="h-14 relative border-b border-white/[0.04] bg-[#0f0f10] shrink-0">
          <div className="relative h-full flex items-end px-4 pb-3.5">
            <div className="flex items-center gap-2 no-drag pointer-events-auto">
              ...
              <span className="text-sm font-bold text-white/80 tracking-tight">豆包助手</span>
            </div>
            ...
            <div className="flex items-center gap-1 no-drag pointer-events-auto">
              ...
              <div className={`flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider transition-all ${
                wsStatus === 'connected'
                  ...
                  : 'bg-amber-500/10 text-amber-400/80 border border-amber-500/20 animate-pulse'
              }`}>
        ...
        <div className="flex-1 overflow-hidden">
          <div className="flex h-full">
            ...
            {/* 右侧图库 */}
            <div
              className={`border-l border-white/[0.05] bg-[#0f0f10] transition-all duration-300 overflow-hidden flex-shrink-0 ${
